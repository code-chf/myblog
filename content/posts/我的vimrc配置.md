...
set noswapfile "取消生成交换文件"
set undofile "自动保存撤销记录，用于文件重新打开之后可以恢复"
set undodir=~/.vim/undodir/ "为这些 ”撤销历史文件“ 建立一个专门的目录"
"}}}"
...
func SetTitle()
	...
	if type == 'java'
		...
		call append(line(".")+1," * Author: codechf")
		call append(line(".")+2," * Mail: chenghf1221@qq.com")
		call append(line(".")+3," * Blog: codechf.cn")
		call append(line(".")+4," * CreatedTime: ".strftime("%F %T"))
		call append(line(".")+5," */")
	endif
